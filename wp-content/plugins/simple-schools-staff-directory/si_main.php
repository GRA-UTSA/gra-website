...
function si_create_bio_post_type()
{
    ...
    register_post_type('si_profile', array(
        'labels' => array(
            'name' => __('Biographies'),
...
?>
	<h3><?php
    _e('School Information', 'simpleschools');
?></h3>
...
?>
    <tr>
			<th>
				<label for="profiledetail"><?php
        _e('Enable Detailed Staff Directory Page?', 'simpleschools');
?>
			</label></th>
			<td align="left">
           
				<input type="checkbox" name="profiledetail" id="profiledetail" value="Yes"  <?php
        if (get_option('profiledetail') == "Yes") {
            echo "checked=\"checked\"";
        }
?>> <label for="profiledetail" ><?php
        _e('Check if you want to include a clickable profile page accessible by clicking on the photo or name in the Staff Directory.<br>Note, each person will have a post generated with their name as the title, and saved in the Staff category.<br>', 'simpleschools');
?></label>
    <input type="checkbox" name="custombio" id="custombio" value="Yes"  <?php
        if (get_option('custombio') == "Yes") {
            echo "checked=\"checked\"";
        }
?>> Check to allow each user to create and edit a custom HTML detail/biography page. <br />
     <input type="checkbox" name="hideemail" id="hideemail" value="Yes"  <?php
        if (get_option('hideemail') == "Yes") {
            echo "checked=\"checked\"";
        }
...
?>
    <input type="checkbox" name="savedroles[<?php
            echo $key;
?>]" value="Yes" <?php
            if ($savedroles[$key] == "Yes") {
                echo 'checked=/"checked/"';
            }
?> /> <?php
            echo $value;
...
?>
        ...
        <tr>
			<th>
				<label for="hidemyemail"><?php
    _e('Hide My E-mail?', 'simpleschools');
?>
			</label></th>
			<td>
				<input type="checkbox" name="hidemyemail" id="hidemyemail" value="Yes"  <?php
    if (get_the_author_meta('hidemyemail', $user->ID) == "Yes") {
        echo "checked=\"checked\"";
    }
?>> Check to hide your e-mail from the Staff Directory. <br />
				<span class="description"><?php
    _e('Choose if you want to hide your e-mail address from the Staff Directory.', 'simpleschools');
?></span>
			</td>
		</tr>
    ...
    _e('Region or District', 'simpleschools');
?>
			</label></th>
			<td>
				<input type="text" name="company" id="company" value="<?php
    echo esc_attr(get_the_author_meta('company', $user->ID));
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Please enter your school region or district.', 'simpleschools');
?></span>
			</td>
		</tr>
        <tr>
    ...
    _e('School or Department', 'simpleschools');
?>
			</label></th>
			<td>
				<input type="text" name="department" id="department" value="<?php
    echo esc_attr(get_the_author_meta('department', $user->ID));
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Please enter your school or department.', 'simpleschools');
?></span>
			</td>
		</tr>
        <tr>
			<th>
				<label for="title"><?php
    _e('Title', 'simpleschools');
?>
			</label></th>
			<td>
				<input type="text" name="title" id="title" value="<?php
    echo esc_attr(get_the_author_meta('title', $user->ID));
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Please enter your teaching specialty or title.', 'simpleschools');
?></span>
			</td>
		</tr>
        	<tr>
    ...
    _e('Address', 'simpleschools');
?>
			</label></th>
			<td><textarea name="address" rows="4" class="regular-text" id="address"><?php
    echo esc_attr(get_the_author_meta('address', $user->ID));
?></textarea>
	      <br />
				<span class="description"><?php
    _e('Please enter your address.', 'simpleschools');
?></span>
			</td>
		</tr>
        <tr>
			<th>
				<label for="postal"><?php
    _e('Zip or Postal Code', 'simpleschools');
?>
			</label></th>
			<td><input type="text" name="postal" id="postal" value="<?php
    echo esc_attr(get_the_author_meta('postal', $user->ID));
?>" class="regular-text" />
	      <br />
				<span class="description"><?php
    _e('Please enter your zip or postal code.', 'simpleschools');
?></span>
			</td>
		</tr>
         <tr>
...
?>
                <input name="phonelabel" type="text" class="regular-text" id="phonelabel" value="<?php
        echo get_option('phonelabel');
?>" size="20" /><?php
    } else {
...
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Please enter your direct business phone #.', 'simpleschools');
?></span>
			</td>
		</tr>
        <tr>
...
?>
                <input name="phoneextlabel" type="text" class="regular-text" id="phoneextlabel" value="<?php
        echo get_option('phoneextlabel');
?>" size="20" /><?php
    } else {
...
?></th>
			<td>
				<input type="text" name="phoneext" id="phoneext" value="<?php
    echo esc_attr(get_the_author_meta('phoneext', $user->ID));
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Please enter your direct phone extension.', 'simpleschools');
?></span>
			</td>
		</tr>
         <tr>
...
?>
                <input name="mobilelabel" type="text" class="regular-text" id="mobilelabel" value="<?php
        echo get_option('mobilelabel');
?>" size="20" /><?php
    } else {
...
?></th>
			<td>
				<input type="text" name="mobilephone" id="mobilephone" value="<?php
    echo esc_attr(get_the_author_meta('mobilephone', $user->ID));
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Please enter your mobile phone number.', 'simpleschools');
?></span>
			</td>
		</tr>
        <tr>
...
?>
                <input name="faxlabel" type="text" class="regular-text" id="faxlabel" value="<?php
        echo get_option('faxlabel');
?>" size="20" /><?php
    } else {
...
?></th>
    ...
    echo esc_attr(get_the_author_meta('fax', $user->ID));
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Please enter your fax number.', 'simpleschools');
?></span>
			</td>
		</tr>
         <tr>
...
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Please enter your city.', 'simpleschools');
?></span>
			</td>
		</tr>
         <tr>
    ...
    _e('Region, state or province', 'simpleschools');
?>
			</label></th>
			<td>
				<input type="text" name="region" id="region" value="<?php
    echo esc_attr(get_the_author_meta('region', $user->ID));
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Please enter your region.', 'simpleschools');
?></span>
			</td>
		</tr>
    ...
    _e('Country', 'simpleschools');
?>
			</label></th>
			<td>
				
                <select name="country" id="country"  class="regular-text" VALUE="<?php
    echo esc_attr(get_the_author_meta('country', $user->ID));
?>">
 <OPTION VALUE="<?php
    echo esc_attr(get_the_author_meta('country', $user->ID));
?>"><?php
...
?>
 <OPTION VALUE="<?php
    _e('Select A Country', 'simpleschools');
?>"><?php
    _e('Select A Country', 'simpleschools');
?>
  <OPTION VALUE="<?php
    _e('Afghanistan', 'simpleschools');
?>">Afghanistan
  <OPTION VALUE="<?php
    _e('Albania', 'simpleschools');
?>">Albania
  <OPTION VALUE="<?php
    _e('Algeria', 'simpleschools');
?>">Algeria
  <OPTION VALUE="<?php
    _e('American Samoa', 'simpleschools');
?>">American Samoa
  <OPTION VALUE="<?php
    _e('Andorra', 'simpleschools');
?>">Andorra
  <OPTION VALUE="<?php
    _e('Angola', 'simpleschools');
?>">Angola
  <OPTION VALUE="<?php
    _e('Anguilla', 'simpleschools');
?>">Anguilla
  <OPTION VALUE="<?php
    _e('Antarctica', 'simpleschools');
?>">Antarctica
  <OPTION VALUE="<?php
    _e('Antigua and Barbuda', 'simpleschools');
?>">Antigua and Barbuda
  <OPTION VALUE="<?php
    _e('Argentina', 'simpleschools');
?>">Argentina
  <OPTION VALUE="<?php
    _e('Armenia', 'simpleschools');
?>">Armenia
  <OPTION VALUE="<?php
    _e('Aruba', 'simpleschools');
?>">Aruba
  <OPTION VALUE="<?php
    _e('Australia', 'simpleschools');
?>">Australia
  <OPTION VALUE="<?php
    _e('Austria', 'simpleschools');
?>">Austria
  <OPTION VALUE="<?php
    _e('Azerbaijan', 'simpleschools');
?>">Azerbaijan
  <OPTION VALUE="<?php
    _e('Bahamas', 'simpleschools');
?>">Bahamas
  <OPTION VALUE="<?php
    _e('Bahrain', 'simpleschools');
?>">Bahrain
  <OPTION VALUE="<?php
    _e('Bangladesh', 'simpleschools');
?>">Bangladesh
  <OPTION VALUE="<?php
    _e('Barbados', 'simpleschools');
?>">Barbados
  <OPTION VALUE="<?php
    _e('Belarus', 'simpleschools');
?>">Belarus
  <OPTION VALUE="<?php
    _e('Belgium', 'simpleschools');
?>">Belgium
  <OPTION VALUE="<?php
    _e('Belize', 'simpleschools');
?>">Belize
  <OPTION VALUE="<?php
    _e('Benin', 'simpleschools');
?>">Benin
  <OPTION VALUE="<?php
    _e('Bermuda', 'simpleschools');
?>">Bermuda
  <OPTION VALUE="<?php
    _e('Bhutan', 'simpleschools');
?>">Bhutan
  <OPTION VALUE="<?php
    _e('Bolivia', 'simpleschools');
?>">Bolivia
  <OPTION VALUE="<?php
    _e('Bosnia and Herzegovina', 'simpleschools');
?>">Bosnia and 
              Herzegovina
  <OPTION VALUE="<?php
    _e('Botswana', 'simpleschools');
?>">Botswana
  <OPTION VALUE="<?php
    _e('Bouvet Island', 'simpleschools');
?>">Bouvet Island
  <OPTION VALUE="<?php
    _e('Brazil', 'simpleschools');
?>">Brazil
  <OPTION VALUE="<?php
    _e('British Indian Ocean Territory', 'simpleschools');
?>">
              British Indian Ocean Territory
  <OPTION VALUE="<?php
    _e('Brunei Darussalam', 'simpleschools');
?>">Brunei Darussalam
  <OPTION VALUE="<?php
    _e('Bulgaria', 'simpleschools');
?>">Bulgaria
  <OPTION VALUE="<?php
    _e('Burkina Faso', 'simpleschools');
?>">Burkina Faso
  <OPTION VALUE="<?php
    _e('Burundi', 'simpleschools');
?>">Burundi
  <OPTION VALUE="<?php
    _e('Cambodia', 'simpleschools');
?>">Cambodia
  <OPTION VALUE="<?php
    _e('Cameroon', 'simpleschools');
?>">Cameroon
  <OPTION VALUE="<?php
    _e('Canada', 'simpleschools');
?>">Canada
  <OPTION VALUE="<?php
    _e('Cape Verde', 'simpleschools');
?>">Cape Verde
  <OPTION VALUE="<?php
    _e('Cayman Islands', 'simpleschools');
?>">Cayman Islands
  <OPTION VALUE="<?php
    _e('Central African Republic', 'simpleschools');
?>">
             Central African Republic
  <OPTION VALUE="<?php
    _e('Chad', 'simpleschools');
?>">Chad
  <OPTION VALUE="<?php
    _e('Chile', 'simpleschools');
?>">Chile
  <OPTION VALUE="<?php
    _e('China', 'simpleschools');
?>">China
  <OPTION VALUE="<?php
    _e('Christmas Island', 'simpleschools');
?>">Christmas Island
  <OPTION VALUE="<?php
    _e('Cocos (Keeling Islands)', 'simpleschools');
?>">
             Cocos (Keeling Islands)
  <OPTION VALUE="<?php
    _e('Colombia', 'simpleschools');
?>">Colombia
  <OPTION VALUE="<?php
    _e('Comoros', 'simpleschools');
?>">Comoros
  <OPTION VALUE="<?php
    _e('Congo', 'simpleschools');
?>">Congo
  <OPTION VALUE="<?php
    _e('Cook Islands', 'simpleschools');
?>">Cook Islands
  <OPTION VALUE="<?php
    _e('Costa Rica', 'simpleschools');
?>">Costa Rica
  <OPTION VALUE="<?php
    _e('Cote D Ivoire (Ivory Coast)', 'simpleschools');
?>">
               Cote D Ivoire (Ivory Coast)
  <OPTION VALUE="<?php
    _e('Croatia (Hrvatska', 'simpleschools');
?>">Croatia (Hrvatska
  <OPTION VALUE="<?php
    _e('Cuba', 'simpleschools');
?>">Cuba
  <OPTION VALUE="<?php
    _e('Cyprus', 'simpleschools');
?>">Cyprus
  <OPTION VALUE="<?php
    _e('Czech Republic', 'simpleschools');
?>">Czech Republic
  <OPTION VALUE="<?php
    _e('Denmark', 'simpleschools');
?>">Denmark
  <OPTION VALUE="<?php
    _e('Djibouti', 'simpleschools');
?>">Djibouti
  <OPTION VALUE="<?php
    _e('Dominican Republic', 'simpleschools');
?>">Dominican Republic
  <OPTION VALUE="<?php
    _e('Dominica', 'simpleschools');
?>">Dominica
  <OPTION VALUE="<?php
    _e('East Timor', 'simpleschools');
?>">East Timor
  <OPTION VALUE="<?php
    _e('Ecuador', 'simpleschools');
?>">Ecuador
  <OPTION VALUE="<?php
    _e('Egypt', 'simpleschools');
?>">Egypt
  <OPTION VALUE="<?php
    _e('El Salvador', 'simpleschools');
?>">El Salvador
  <OPTION VALUE="<?php
    _e('Equatorial Guinea', 'simpleschools');
?>">Equatorial Guinea
  <OPTION VALUE="<?php
    _e('Eritrea', 'simpleschools');
?>">Eritrea
  <OPTION VALUE="<?php
    _e('Estonia', 'simpleschools');
?>">Estonia
  <OPTION VALUE="<?php
    _e('Ethiopia', 'simpleschools');
?>">Ethiopia
  <OPTION VALUE="<?php
    _e('Falkland Islands (Malvinas)', 'simpleschools');
?>">
                  Falkland Islands (Malvinas)
  <OPTION VALUE="<?php
    _e('Faroe Islands', 'simpleschools');
?>">Faroe Islands
  <OPTION VALUE="<?php
    _e('Fiji', 'simpleschools');
?>">Fiji
  <OPTION VALUE="<?php
    _e('Finland', 'simpleschools');
?>">Finland
  <OPTION VALUE="<?php
    _e('France, Metropolitan', 'simpleschools');
?>">France, Metropolitan
  <OPTION VALUE="<?php
    _e('France', 'simpleschools');
?>">France
  <OPTION VALUE="<?php
    _e('French Guiana', 'simpleschools');
?>">French Guiana
  <OPTION VALUE="<?php
    _e('French Polynesia', 'simpleschools');
?>">French Polynesia
  <OPTION VALUE="<?php
    _e('French Southern Territories', 'simpleschools');
?>">
              French Southern Territories
  <OPTION VALUE="<?php
    _e('Gabon', 'simpleschools');
?>">Gabon
  <OPTION VALUE="<?php
    _e('Gambia', 'simpleschools');
?>">Gambia
  <OPTION VALUE="<?php
    _e('Georgia', 'simpleschools');
?>">Georgia
  <OPTION VALUE="<?php
    _e('Germany', 'simpleschools');
?>">Germany
  <OPTION VALUE="<?php
    _e('Ghana', 'simpleschools');
?>">Ghana
  <OPTION VALUE="<?php
    _e('Gibraltar', 'simpleschools');
?>">Gibraltar
  <OPTION VALUE="<?php
    _e('Greece', 'simpleschools');
?>">Greece
  <OPTION VALUE="<?php
    _e('Greenland', 'simpleschools');
?>">Greenland
  <OPTION VALUE="<?php
    _e('Grenada', 'simpleschools');
?>">Grenada
  <OPTION VALUE="<?php
    _e('Guadeloupe', 'simpleschools');
?>">Guadeloupe
  <OPTION VALUE="<?php
    _e('Guam', 'simpleschools');
?>">Guam
  <OPTION VALUE="<?php
    _e('Guatemala', 'simpleschools');
?>">Guatemala
  <OPTION VALUE="<?php
    _e('Guinea-Bissau', 'simpleschools');
?>">Guinea-Bissau
  <OPTION VALUE="<?php
    _e('Guinea', 'simpleschools');
?>">Guinea
  <OPTION VALUE="<?php
    _e('Guyana', 'simpleschools');
?>">Guyana
  <OPTION VALUE="<?php
    _e('Haiti', 'simpleschools');
?>">Haiti
  <OPTION VALUE="<?php
    _e('Heard and McDonald Islands', 'simpleschools');
?>">
            Heard and McDonald Islands
  <OPTION VALUE="<?php
    _e('Honduras', 'simpleschools');
?>">Honduras
  <OPTION VALUE="<?php
    _e('Hong Kong', 'simpleschools');
?>">Hong Kong
  <OPTION VALUE="<?php
    _e('Hungary', 'simpleschools');
?>">Hungary
  <OPTION VALUE="<?php
    _e('Iceland', 'simpleschools');
?>">Iceland
  <OPTION VALUE="<?php
    _e('India', 'simpleschools');
?>">India
  <OPTION VALUE="<?php
    _e('Indonesia', 'simpleschools');
?>">Indonesia
  <OPTION VALUE="<?php
    _e('Iran', 'simpleschools');
?>">Iran
  <OPTION VALUE="<?php
    _e('Iraq', 'simpleschools');
?>">Iraq
  <OPTION VALUE="<?php
    _e('Ireland', 'simpleschools');
?>">Ireland
  <OPTION VALUE="<?php
    _e('Israel', 'simpleschools');
?>">Israel
  <OPTION VALUE="<?php
    _e('Italy', 'simpleschools');
?>">Italy
  <OPTION VALUE="<?php
    _e('Jamaica', 'simpleschools');
?>">Jamaica
  <OPTION VALUE="<?php
    _e('Japan', 'simpleschools');
?>">Japan
  <OPTION VALUE="<?php
    _e('Jordan', 'simpleschools');
?>">Jordan
  <OPTION VALUE="<?php
    _e('Kazakhstan', 'simpleschools');
?>">Kazakhstan
  <OPTION VALUE="<?php
    _e('Kenya', 'simpleschools');
?>">Kenya
  <OPTION VALUE="<?php
    _e('Kiribati', 'simpleschools');
?>">Kiribati
  <OPTION VALUE="<?php
    _e('Korea (North)', 'simpleschools');
?>">Korea (North)
  <OPTION VALUE="<?php
    _e('Korea (South)', 'simpleschools');
?>">Korea (South)
  <OPTION VALUE="<?php
    _e('Kuwait', 'simpleschools');
?>">Kuwait
  <OPTION VALUE="<?php
    _e('Kyrgyzstan', 'simpleschools');
?>">Kyrgyzstan
  <OPTION VALUE="<?php
    _e('Laos', 'simpleschools');
?>">Laos
  <OPTION VALUE="<?php
    _e('Latvia', 'simpleschools');
?>">Latvia
  <OPTION VALUE="<?php
    _e('Lebanon', 'simpleschools');
?>">Lebanon
  <OPTION VALUE="<?php
    _e('Lesotho', 'simpleschools');
?>">Lesotho
  <OPTION VALUE="<?php
    _e('Liberia', 'simpleschools');
?>">Liberia
  <OPTION VALUE="<?php
    _e('Libya', 'simpleschools');
?>">Libya
  <OPTION VALUE="<?php
    _e('Liechtenstein', 'simpleschools');
?>">Liechtenstein
  <OPTION VALUE="<?php
    _e('Lithuania', 'simpleschools');
?>">Lithuania
  <OPTION VALUE="<?php
    _e('Luxembourg', 'simpleschools');
?>">Luxembourg
  <OPTION VALUE="<?php
    _e('Macau', 'simpleschools');
?>">Macau
  <OPTION VALUE="<?php
    _e('Macedonia', 'simpleschools');
?>">Macedonia
  <OPTION VALUE="<?php
    _e('Madagascar', 'simpleschools');
?>">Madagascar
  <OPTION VALUE="<?php
    _e('Malawi', 'simpleschools');
?>">Malawi
  <OPTION VALUE="<?php
    _e('Malaysia', 'simpleschools');
?>">Malaysia
  <OPTION VALUE="<?php
    _e('Maldives', 'simpleschools');
?>">Maldives
  <OPTION VALUE="<?php
    _e('Mali', 'simpleschools');
?>">Mali
  <OPTION VALUE="<?php
    _e('Malta', 'simpleschools');
?>">Malta
  <OPTION VALUE="<?php
    _e('Marshall Islands', 'simpleschools');
?>">Marshall Islands
  <OPTION VALUE="<?php
    _e('Martinique', 'simpleschools');
?>">Martinique
  <OPTION VALUE="<?php
    _e('Mauritania', 'simpleschools');
?>">Mauritania
  <OPTION VALUE="<?php
    _e('Mauritius', 'simpleschools');
?>">Mauritius
  <OPTION VALUE="<?php
    _e('Mayotte', 'simpleschools');
?>">Mayotte
  <OPTION VALUE="<?php
    _e('Mexico', 'simpleschools');
?>">Mexico
  <OPTION VALUE="<?php
    _e('Micronesia', 'simpleschools');
?>">Micronesia
  <OPTION VALUE="<?php
    _e('Moldova', 'simpleschools');
?>">Moldova
  <OPTION VALUE="<?php
    _e('Monaco', 'simpleschools');
?>">Monaco
  <OPTION VALUE="<?php
    _e('Mongolia', 'simpleschools');
?>">Mongolia
  <OPTION VALUE="<?php
    _e('Montserrat', 'simpleschools');
?>">Montserrat
  <OPTION VALUE="<?php
    _e('Morocco', 'simpleschools');
?>">Morocco
  <OPTION VALUE="<?php
    _e('Mozambique', 'simpleschools');
?>">Mozambique
  <OPTION VALUE="<?php
    _e('Myanmar', 'simpleschools');
?>">Myanmar
  <OPTION VALUE="<?php
    _e('Namibia', 'simpleschools');
?>">Namibia
  <OPTION VALUE="<?php
    _e('Nauru', 'simpleschools');
?>">Nauru
  <OPTION VALUE="<?php
    _e('Nepal', 'simpleschools');
?>">Nepal
  <OPTION VALUE="<?php
    _e('Netherlands Antilles', 'simpleschools');
?>">Netherlands Antilles
  <OPTION VALUE="<?php
    _e('Netherlands', 'simpleschools');
?>">Netherlands
  <OPTION VALUE="<?php
    _e('New Caledonia', 'simpleschools');
?>">New Caledonia
  <OPTION VALUE="<?php
    _e('New Zealand', 'simpleschools');
?>">New Zealand
  <OPTION VALUE="<?php
    _e('Nicaragua', 'simpleschools');
?>">Nicaragua
  <OPTION VALUE="<?php
    _e('Nigeria', 'simpleschools');
?>">Nigeria
  <OPTION VALUE="<?php
    _e('Niger', 'simpleschools');
?>">Niger
  <OPTION VALUE="<?php
    _e('Niue', 'simpleschools');
?>">Niue
  <OPTION VALUE="<?php
    _e('Norfolk Island', 'simpleschools');
?>">Norfolk Island
  <OPTION VALUE="<?php
    _e('Northern Mariana Islands', 'simpleschools');
?>">
             Northern Mariana Islands
  <OPTION VALUE="<?php
    _e('Norway', 'simpleschools');
?>">Norway
  <OPTION VALUE="<?php
    _e('Oman', 'simpleschools');
?>">Oman
  <OPTION VALUE="<?php
    _e('Pakistan', 'simpleschools');
?>">Pakistan
  <OPTION VALUE="<?php
    _e('Palau', 'simpleschools');
?>">Palau
  <OPTION VALUE="<?php
    _e('Panama', 'simpleschools');
?>">Panama
  <OPTION VALUE="<?php
    _e('Papua New Guinea', 'simpleschools');
?>">Papua New Guinea
  <OPTION VALUE="<?php
    _e('Paraguay', 'simpleschools');
?>">Paraguay
  <OPTION VALUE="<?php
    _e('Peru', 'simpleschools');
?>">Peru
  <OPTION VALUE="<?php
    _e('Philippines', 'simpleschools');
?>">Philippines
  <OPTION VALUE="<?php
    _e('Pitcairn', 'simpleschools');
?>">Pitcairn
  <OPTION VALUE="<?php
    _e('Poland', 'simpleschools');
?>">Poland
  <OPTION VALUE="<?php
    _e('Portugal', 'simpleschools');
?>">Portugal
  <OPTION VALUE="<?php
    _e('Puerto Rico', 'simpleschools');
?>">Puerto Rico
  <OPTION VALUE="<?php
    _e('Qatar', 'simpleschools');
?>">Qatar
  <OPTION VALUE="<?php
    _e('Reunion', 'simpleschools');
?>">Reunion
  <OPTION VALUE="<?php
    _e('Romania', 'simpleschools');
?>">Romania
  <OPTION VALUE="<?php
    _e('Russian Federation', 'simpleschools');
?>">Russian Federation
  <OPTION VALUE="<?php
    _e('Rwanda', 'simpleschools');
?>">Rwanda
  <OPTION VALUE="<?php
    _e('S. Georgia and S. Sandwich Isls.', 'simpleschools');
?>">
         S. Georgia and S. Sandwich Isls.
  <OPTION VALUE="<?php
    _e('Saint Kitts and Nevis', 'simpleschools');
?>">Saint Kitts and Nevis
  <OPTION VALUE="<?php
    _e('Saint Lucia', 'simpleschools');
?>">Saint Lucia
  <OPTION VALUE="<?php
    _e('Saint Vincent and The Grenadines', 'simpleschools');
?>">
         Saint Vincent and The Grenadines
  <OPTION VALUE="<?php
    _e('Samoa', 'simpleschools');
?>">Samoa
  <OPTION VALUE="<?php
    _e('San Marino', 'simpleschools');
?>">San Marino
  <OPTION VALUE="<?php
    _e('Sao Tome and Principe', 'simpleschools');
?>">Sao Tome and Principe
  <OPTION VALUE="<?php
    _e('Saudi Arabia', 'simpleschools');
?>">Saudi Arabia
  <OPTION VALUE="<?php
    _e('Senegal', 'simpleschools');
?>">Senegal
  <OPTION VALUE="<?php
    _e('Seychelles', 'simpleschools');
?>">Seychelles
  <OPTION VALUE="<?php
    _e('Sierra Leone', 'simpleschools');
?>">Sierra Leone
  <OPTION VALUE="<?php
    _e('Singapore', 'simpleschools');
?>">Singapore
  <OPTION VALUE="<?php
    _e('Slovak Republic', 'simpleschools');
?>">Slovak Republic
  <OPTION VALUE="<?php
    _e('Slovenia', 'simpleschools');
?>">Slovenia
  <OPTION VALUE="<?php
    _e('Solomon Islands', 'simpleschools');
?>">Solomon Islands
  <OPTION VALUE="<?php
    _e('Somalia', 'simpleschools');
?>">Somalia
  <OPTION VALUE="<?php
    _e('South Africa', 'simpleschools');
?>">South Africa
  <OPTION VALUE="<?php
    _e('Spain', 'simpleschools');
?>">Spain
  <OPTION VALUE="<?php
    _e('Sri Lanka', 'simpleschools');
?>">Sri Lanka
  <OPTION VALUE="<?php
    _e('St. Helena', 'simpleschools');
?>">St. Helena
  <OPTION VALUE="<?php
    _e('St. Pierre and Miquelon', 'simpleschools');
?>">
              St. Pierre and Miquelon
  <OPTION VALUE="<?php
    _e('Sudan', 'simpleschools');
?>">Sudan
  <OPTION VALUE="<?php
    _e('Suriname', 'simpleschools');
?>">Suriname
  <OPTION VALUE="<?php
    _e('Svalbard and Jan Mayen Islands', 'simpleschools');
?>">
              Svalbard and Jan Mayen Islands
  <OPTION VALUE="<?php
    _e('Swaziland', 'simpleschools');
?>">Swaziland
  <OPTION VALUE="<?php
    _e('Sweden', 'simpleschools');
?>">Sweden
  <OPTION VALUE="<?php
    _e('Switzerland', 'simpleschools');
?>">Switzerland
  <OPTION VALUE="<?php
    _e('Syria', 'simpleschools');
?>">Syria
  <OPTION VALUE="<?php
    _e('Taiwan', 'simpleschools');
?>">Taiwan
  <OPTION VALUE="<?php
    _e('Tajikistan', 'simpleschools');
?>">Tajikistan
  <OPTION VALUE="<?php
    _e('Tanzania', 'simpleschools');
?>">Tanzania
  <OPTION VALUE="<?php
    _e('Thailand', 'simpleschools');
?>">Thailand
  <OPTION VALUE="<?php
    _e('Togo', 'simpleschools');
?>">Togo
  <OPTION VALUE="<?php
    _e('Tokelau', 'simpleschools');
?>">Tokelau
  <OPTION VALUE="<?php
    _e('Tonga', 'simpleschools');
?>">Tonga
  <OPTION VALUE="<?php
    _e('Trinidad and Tobago', 'simpleschools');
?>">Trinidad and Tobago
  <OPTION VALUE="<?php
    _e('Tunisia', 'simpleschools');
?>">Tunisia
  <OPTION VALUE="<?php
    _e('Turkey', 'simpleschools');
?>">Turkey
  <OPTION VALUE="<?php
    _e('Turkmenistan', 'simpleschools');
?>">Turkmenistan
  <OPTION VALUE="<?php
    _e('Turks and Caicos Islands', 'simpleschools');
?>">
       Turks and Caicos Islands
  <OPTION VALUE="<?php
    _e('Tuvalu', 'simpleschools');
?>">Tuvalu
  <OPTION VALUE="<?php
    _e('US Minor Outlying Islands', 'simpleschools');
?>">
     US Minor Outlying Islands
  <OPTION VALUE="<?php
    _e('Uganda', 'simpleschools');
?>">Uganda
  <OPTION VALUE="<?php
    _e('Ukraine', 'simpleschools');
?>">Ukraine
  <OPTION VALUE="<?php
    _e('United Arab Emirates', 'simpleschools');
?>">
     United Arab Emirates
  <OPTION VALUE="<?php
    _e('United Kingdom', 'simpleschools');
?>">United Kingdom
  <OPTION VALUE="<?php
    _e('United States', 'simpleschools');
?>">United States
  <OPTION VALUE="<?php
    _e('Uruguay', 'simpleschools');
?>">Uruguay
  <OPTION VALUE="<?php
    _e('Uzbekistan', 'simpleschools');
?>">Uzbekistan
  <OPTION VALUE="<?php
    _e('Vanuatu', 'simpleschools');
?>">Vanuatu
  <OPTION VALUE="<?php
    _e('Vatican City State', 'simpleschools');
?>">Vatican City State
  <OPTION VALUE="<?php
    _e('Venezuela', 'simpleschools');
?>">Venezuela
  <OPTION VALUE="<?php
    _e('Viet Nam', 'simpleschools');
?>">Viet Nam
  <OPTION VALUE="<?php
    _e('Virgin Islands (British)', 'simpleschools');
?>">
     Virgin Islands (British)
  <OPTION VALUE="<?php
    _e('Virgin Islands (US)', 'simpleschools');
?>">
     Virgin Islands (US)
  <OPTION VALUE="<?php
    _e('Wallis and Futuna Islands', 'simpleschools');
?>">
     Wallis and Futuna Islands
  <OPTION VALUE="<?php
    _e('Western Sahara', 'simpleschools');
?>">Western Sahara
  <OPTION VALUE="<?php
    _e('Yemen', 'simpleschools');
?>">Yemen
  <OPTION VALUE="<?php
    _e('Yugoslavia', 'simpleschools');
?>">Yugoslavia
  <OPTION VALUE="<?php
    _e('Zaire', 'simpleschools');
?>">Zaire
  <OPTION VALUE="<?php
    _e('Zambia', 'simpleschools');
?>">Zambia
  <OPTION VALUE="<?php
    _e('Zimbabwe', 'simpleschools');
?>">Zimbabwe
</SELECT>
                <br />
				<span class="description"><?php
    _e('Please enter your country.', 'simpleschools');
?></span>
			</td>
		</tr>
...
?>
                <input name="custom1label" type="text" class="regular-text" id="custom1label" value="<?php
        echo get_option('custom1label');
?>" size="20" /><?php
    } else {
...
?>
			...
			<td>
				<input type="text" name="custom1" id="custom1" value="<?php
    echo get_the_author_meta('custom1', $user->ID);
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Enter a custom field that will show up in the Staff Directory if populated. HTML code is OK, but use carefully.', 'simpleschools');
?></span>
			</td>
		</tr>
          <tr>
...
?>
                <input name="custom2label" type="text" class="regular-text" id="custom2label" value="<?php
        echo get_option('custom2label');
?>" size="20" /><?php
    } else {
...
?>
			...
			<td>
				<input type="text" name="custom2" id="custom2" value="<?php
    echo get_the_author_meta('custom2', $user->ID);
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Enter a custom field that will show up in the Staff Directory if populated. HTML code is OK, but use carefully.', 'simpleschools');
?></span>
...
?>
                <input name="custom3label" type="text" class="regular-text" id="custom3label" value="<?php
        echo get_option('custom3label');
?>" size="20" /><?php
    } else {
...
?>
			...
			<td>
				<input type="text" name="custom3" id="custom3" value="<?php
    echo get_the_author_meta('custom3', $user->ID);
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Enter a custom field that will show up in the Staff Directory if populated. HTML code is OK, but use carefully.', 'simpleschools');
?></span>
         ...
         <tr>
			<th>
				<label for="si_office_status"><?php
    _e('Away from school? ', 'simpleschools');
?></label> </th><td>            
	<?php
...
?>>Yes</option>   
				...
				<span class="description"><?php
    _e('Update away from school status.', 'simpleschools');
?> </span>
			</td>
		</tr>
          <tr>
			<th>
				<label for="expiry"><?php
    _e('Away from school expiry?', 'simpleschools');
?>
			</label></th>
            
			<td><input type="checkbox" name="expiry" id="expiry" value="Yes"  <?php
    if (get_the_author_meta('expiry', $user_id) == "Yes") {
        echo "checked=\"checked\"";
    }
?>> <label for="expiry" ><?php
    _e('Check to set an expiry date for the away from school alert: ', 'simpleschools');
?></label><?php
    ...
    {
        wp_enqueue_script('field-date-js', 'js/Field_Date.js', array(
            'jquery',
            'jquery-ui-core',
...
?><br />
				<span class="description"><?php
    _e('Enter the day you are back in when the alert will be turned off.', 'simpleschools');
?></span>
                <br /><input type="text" name="expirytext" id="expirytext" value="<?php
    echo esc_attr(get_the_author_meta('expirytext', $user->ID));
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Enter custom back in text above, assuming activated.', 'simpleschools');
?></span>
			</td>
		</tr>
         ...
         <tr>
			<th>
				<label for="officenotification"><?php
    _e('Away from school text', 'simpleschools');
?>
			</label></th>
			<td>
				<input type="text" name="officenotification" id="officenotification" value="<?php
    echo esc_attr(get_the_author_meta('officenotification', $user->ID));
?>" class="regular-text" /><br />
				<span class="description"><?php
    _e('Enter custom away from school notification text here, assuming activated.', 'simpleschools');
?></span>
			</td>
		</tr>
        <tr>
			<th>
				<label for="exclude"><?php
    _e('Exclude from Staff Directory?', 'simpleschools');
?>
			</label></th>
			<td align="left">
				<input type="checkbox" name="exclude" id="exclude" value="Yes"  <?php
    if (get_the_author_meta('exclude', $user->ID) == "Yes") {
        echo "checked=\"checked\"";
    }
?>> <label for="exclude" ><?php
    _e('Check if you want to exclude from the Staff Directory and Staff Widget.', 'simpleschools');
?></label></td>
		</tr>
        <tr>
			<th>
				<label for="includebio"><?php
    _e('Include Biography in Directory?', 'simpleschools');
?>
			</label></th>
			<td align="left">
				<input type="checkbox" name="includebio" id="includebio" value="Yes"  <?php
    if (get_the_author_meta('includebio', $user->ID) == "Yes") {
        echo "checked=\"checked\"";
    }
?>> <label for="includebio" ><?php
    _e('Check if you want to include a biography in the Staff Directory.', 'simpleschools');
?></label></td>
		</tr>
       <?php
    if (current_user_can('administrator')) {
?> 
       ...
       <tr>
			<th>
				<label for="phoneaustralia"><?php
        _e('Australian Phone Format?', 'simpleschools');
?>
			</label></th>
			<td align="left">
				<input type="checkbox" name="phoneaustralia" id="phoneaustralia" value="Yes"  <?php
        if (get_option('phoneaustralia') == "Yes") {
            echo "checked=\"checked\"";
        }
?>> <label for="phoneaustralia" ><?php
        _e('Use Australian phone format for Staff Directory.', 'simpleschools');
?></label></td>
		</tr>
...
function si_admin_scripts()
{
    ...
    wp_register_script('my-upload', WP_PLUGIN_URL . '/custom_header.js', array(
        'jquery',
        'media-upload',
        'thickbox'
    ));
...
function si_add_logo_init()
{
    ...
    if (!empty($_POST['add_logo_submit'])) {
        ...
        if ($_FILES["file"]["type"]) {
            ...
            move_uploaded_file($_FILES["file"]["tmp_name"], $add_logo_directory . '/' . $image);
            update_option('add_logo_logo', $add_logo_upload_dir['baseurl'] . "/logos/" . $image);
            update_option('add_logo_filename', $image);
        }
        
        if ($_POST['add_logo_on_login'])
            update_option('add_logo_on_login', $_POST['add_logo_on_login']);
        if ($_POST['add_logo_on_admin'])
            update_option('add_logo_on_admin', $_POST['add_logo_on_admin']);
...
{
    global $add_logo_directory, $add_logo_upload_dir;
    if (!file_exists($add_logo_directory))
        mkdir($add_logo_directory, 0755);
...
?>
    <div class="wrap">
        ...
        <?php
    if ($_REQUEST['saved']) {
        _e('<div id="message" class="updated fade"><p><strong>Logo settings saved.</strong></p></div>');
    }
    if ($_REQUEST['deleted']) {
        _e('<div id="message" class="updated fade"><p><strong>Logo deleted.</strong></p></div>');
    }
?>
        ...
        <th scope="row" style="width: 370px;">
            <label for="add_logo_on_login"><?php
    _e('Would you like your logo to appear on the home-page and login page?');
?></label>
        </th>
        <td>
            <input type="radio" name="add_logo_on_login" value="yes" <?php
    checked($default_login, "yes");
?> /><?php
    _e('&nbsp;Yes');
?>
            <input type="radio" name="add_logo_on_login" value="no" <?php
    checked($default_login, "no");
?> /><?php
    _e('&nbsp;No');
?>
        </td>
        ...
        <tr valign="top">
        <th scope="row" style="width: 370px;">
            <label for="add_logo_on_admin"><?php
    _e('Would you like your logo to appear on the admin pages?');
?></label>
        </th>
        <td>
            <input type="radio" name="add_logo_on_admin" value="yes" <?php
    checked($default_admin, "yes");
?> /><?php
    _e('&nbsp;Yes');
?>
            <input type="radio" name="add_logo_on_admin" value="no" <?php
    checked($default_admin, "no");
?> /><?php
    _e('&nbsp;No');
?>
        </td>
        ...
        <tr valign="top">
        <th scope="row" style="width: 370px;">
            <label for="add_logo_logo"><?php
    _e('Choose a file to upload: ');
?></label>
        </th>
        <td>
            <input type="file" name="file" id="file" /><?php
    _e('<em><small>Click Save Changes below to upload your logo.</small></em><br />
...
?>
    ...
    while ($file = readdir($dir_handle)) {
        ...
        if ($count == 1) {
            _e('<br /><br />Select which logo you would like to use.<br />');
            $count++;
        }
        if ($file == get_option('add_logo_filename')) {
            $checked = "checked";
        } else {
            $checked = "";
        }
...
?>    </td>
        ...
        <p class="submit">
        <input type="submit" name="add_logo_submit" class="button-primary" value="<?php
    _e('Save Changes');
?>" />
        </p>
 	    <?php
    if (function_exists('wp_nonce_field'))
        wp_nonce_field('add_logo_to_admin_nonce', 'add_logo_to_admin_nonce');
?>
       </form>
...
function si_contributors($params = array())
{
    ...
    */
    ...
    echo('<div class="row"><div class="col-sm-6" style="opacity:0.0;">_</div><div class="col-sm-6" style="opacity:0.0;">_</div>');
...
<span class="sid_custom1_label">' . $custom1label . '</span><span class="sid_custom1">' . $custom1 . $cu1 . '</span><span class="sid_custom2_label">' . $custom2label . '</span><span class="sid_custom2">' . $custom2 . $cu2 . '</span><span class="sid_custom3_label">' . $custom3label . '</span><span class="sid_custom3">' . $custom3 . $cu3 . '</span><span class="sid_website">' . $website . '</span></div><div class="socialicons">' . $twitter . $facebook . $linkedin . $googleplus . '</div><br><div class="employeebiographyprofile">' . $biography . '</div></div>',
            ...
            echo '<div id="wrap" class="col-sm-6 col-xs-12" style="margin-top:10px;margin-bottom:10px;"><div class="employeephoto">';
            if ($addprofile == "Yes") {
?><a href="<?php
...
?><?php
            if ($addprofile == "Yes") {
?>
<div class="sid_fullname"><a href="<?php
                echo get_permalink($post_id);
?>"><?php
                echo $first . ' ' . $last;
?></a></div>
...
class OutOfOfficeWidget extends WP_Widget
{
    ...
    {
        $widget_ops = array(
            'classname' => 'OutOfOfficeWidget',
            'description' => __('Displays a list of staff who are away.')
        );
...
class EmployeesWidget extends WP_Widget
{
    ...
    {
        $widget_ops = array(
            'classname' => 'EmployeesWidget',
            'description' => __('Displays a list of staff.')
        );
